        ...
        <div style={modalStyle}>
            ...
            <form>
                ...
                <div className="formGroup">
                    ...
                    <input type="text" value={props.selectedPartner.businessType} name="businessType" onChange={props.handleEditChange} id="editBusinessType"/>
                </div>
